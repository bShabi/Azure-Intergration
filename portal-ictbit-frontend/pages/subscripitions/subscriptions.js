...
export default function Subscriptions() {
  ...
  const renameSubscription = (id) => {
    ...
    axios
      ...
      .then((res) => {
        toast(
          'בקשה נשלחה בהצלחהת העדכון עלול לקחת זמן.'
        );
      })
      .catch((err) => {
  ...
  const addTagSubscription = (id) => {
    ...
    axios
      ...
      .then((res) => {
        toast(
          'בקשה נשלחה בהצלחה, עדכון עלול לקחת זמן.'
        );
      })
      .catch((err) => {
        toast.error('שגיאה כללית');
                ...
                <tbody>
                  {subscriptions.map((el) => (
                    <tr>
                      ...
                      <td>
                        <button
                          onClick={(e) => renameSubscription(el.subscriptionId)}
                ...
                <tbody>
                  {subscriptions.map((el) => (
                    <tr>
                      ...
                      <td>
                        <button
                          onClick={(e) => addTagSubscription(el.subscriptionId)}
                          className='btn btn-info btn-sm '>
                          Add
                        </button>
                      </td>
